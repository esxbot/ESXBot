...
exports.exec = (ESXBot, message) => {
  ...
  let comicDate = new Date(ESXBot.functions.getRandomInt(startDate, lastDate));
  ...
  message.channel.send({
    ...
    if (e.status === 404) {
      return ESXBot.emit('error', '', 'I\'m sorry. I was unable to react Garfield at that moment. Could you try again?', message.channel);
    }
    ESXBot.log.error(e);
  });
};
