...
exports.exec = async (ESXBot, message, args) => {
  try {
    ...
    if (e.toString() === 'UDP Watchdog Timeout') {
      return ESXBot.emit('error', ESXBot.strings.error(message.guild.language, 'connection'), ESXBot.strings.error(message.guild.language, 'invalidIPPort', true), message.channel);
    }
    ESXBot.log.error(e);
  }
};
