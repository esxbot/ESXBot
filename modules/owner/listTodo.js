...
exports.exec = async (ESXBot, message, args) => {
  try {
    ...
    if (!todo || todo.list === '[]') {
      ...
      * @fires error
      */
      return ESXBot.emit('error', ESXBot.strings.error(message.guild.language, 'notFound'), ESXBot.strings.error(message.guild.language, 'todoNotFound', true, message.author.username), message.channel);
    }
