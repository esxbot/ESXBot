...
exports.exec = async (ESXBot, message, args) => {
  try {
    ...
    if (user.lastMessageID) {
      ...
      description = ESXBot.strings.info(message.guild.language, 'lastSeen', user.tag, lastSeen);
    }
    else {
      color = ESXBot.colors.RED;
      description = ESXBot.strings.info(message.guild.language, 'notSeen', user.tag);
    }
...
exports.help = {
  ...
  example: [ 'lastSeen @ESXBot#0001', 'lastSeen 167144269485733961' ]
};
