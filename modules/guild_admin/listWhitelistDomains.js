...
exports.exec = async (ESXBot, message, args) => {
  try {
    ...
    if (!guildSettings || guildSettings.whitelistDomains === '[]') {
      ...
      * @fires error
      */
      return ESXBot.emit('error', ESXBot.strings.error(message.guild.language, 'notFound'), ESXBot.strings.error(message.guild.language, 'notSet', true, 'whitelisted domain'), message.channel);
    }
