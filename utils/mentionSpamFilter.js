    ...
    if (message.mentions.users.size >= guild.mentionSpamThreshold) {
      ...
      message.channel.send({
        embed: {
          ...
          description: `Filtrou um spam de menção de ${message.author} com **${message.mentions.users.size}** menciona e ${action} ele.`
        }
      }).catch(e => {
