...
/**
 * Deletes the message with the invite URL (if ESXBot has permission)
 * and warns the user
...
function deleteInvite(message) {
  ...
  message.channel.send({
    embed: {
      ...
      description: `${message.author} você não tem permissão para postar links de convite do servidor aqui.`
    }
  }).then(msg => {
